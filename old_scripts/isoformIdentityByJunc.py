                    ...
                    if len(refBedExons) != 1:
                        if queryBed.name not in resultDict:
                            ...
                            if resultDict[queryBed.name][0] == "monoExon":
                                continue
                            if overlapRatio * overlapRatio2query > resultDict[queryBed.name][3] * \
                                    resultDict[queryBed.name][4]:
                        ...
                        if queryBed.name not in resultDict:
                            ...
                            if resultDict[queryBed.name][0] == "incorrect":
                                if annotation == "incorrect":
                                    if overlapRatio2query * overlapRatio > resultDict[queryBed.name][4] * resultDict[queryBed.name][3]:
                                        resultDict[queryBed.name] = [annotation, consensusIntronN, refBed.name, overlapRatio,
                                                                     overlapRatio2query]
                                else:
                                ...
                                if resultDict[queryBed.name][0] == "exon_alt_in_middle":
                                    if annotation == "partial_truncated":
                                        resultDict[queryBed.name] = [annotation, consensusIntronN, refBed.name,
                                                                     overlapRatio, overlapRatio2query]
                                    elif annotation == "exon_alt_in_middle":
                                        if overlapRatio2query > resultDict[queryBed.name][4]:
                                            resultDict[queryBed.name] = [annotation, consensusIntronN, refBed.name,
                                                                         overlapRatio, overlapRatio2query]
                                else:
                                    if resultDict[queryBed.name][0] == "partial_truncated":
                                        if annotation == "partial_truncated" or annotation == "exon_alt_in_middle":
                                            if overlapRatio2query > resultDict[queryBed.name][4]:
                                                resultDict[queryBed.name] = [annotation, consensusIntronN, refBed.name,
                                                                             overlapRatio, overlapRatio2query]
                    else:
                        if queryBed.name not in resultDict:
                            ...
                            if resultDict[queryBed.name][0] == "incorrect":
                                ...
                                if consensusIntronN > resultDict[queryBed.name][1]:
                                    resultDict[queryBed.name] = ["incorrect", consensusIntronN, "none6;" + refBed.name,
                                                                 overlapRatio, overlapRatio2query]
            if len(queryBedExons) == 1:
                if queryBed.name not in resultDict:

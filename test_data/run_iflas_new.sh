...
############ wangbo hybrid
python iflas.py preproc -cfg test_data/iFLAS_config_wangbo_hybrid_merged_new.cfg
...
python iflas.py refine -cfg test_data/iFLAS_config_wangbo_hybrid_merged_new.cfg
...
python iflas.py allelic_as -cfg test_data/iFLAS_config_wangbo_hybrid_merged_new.cfg

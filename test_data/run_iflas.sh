...
python iflas.py visual_as -c iFLAS_config_wangbo.cfg -g Zm00001d050245
...
python iflas.py preproc -c iFLAS_config_wangbo_merge.cfg
python iflas.py mapping -c iFLAS_config_wangbo_merge.cfg
python iflas.py filter -c iFLAS_config_wangbo_merge.cfg
python iflas.py collapse -c iFLAS_config_wangbo_merge.cfg
python iflas.py find_as -c iFLAS_config_wangbo_merge.cfg
python iflas.py visual_as -c iFLAS_config_wangbo_merge.cfg -g Zm00001d050245
python iflas.py rank_as -c iFLAS_config_wangbo_merge.cfg
python iflas.py diff_as -c iFLAS_config_wangbo_merge.cfg -d wangbo_compCond.txt
python iflas.py go -c iFLAS_config_wangbo_merge.cfg -tg targetGene1.txt,targetGene2.txt,targetGene3.txt -bg gene2go.txt -s sample1,sample2,sample3
python iflas.py report -c iFLAS_config_wangbo_merge.cfg
...
python iflas.py visual_as -c iFLAS_config_wanglab.cfg -g Zm00001d050245
...
python iflas.py visual_as -c iFLAS_config_ont.cfg -g Zm00001d050245
...
python iflas.py visual_as -c iFLAS_config_wangbo_hybrid.cfg -g Zm00001d050245

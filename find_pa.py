...
def find_pa(dataObj=None, refParams=None, dirSpec=None, filterPaByCount=5):
    ...
    getPaCluster(readsBed="reads.assigned.unambi.bed12+", tofuGroup="tofu.collapsed.group.txt", threads=dataObj.single_run_threads, paClusterOut="paCluster.bed8+", paDist=10)
